...
image1 = ImageTk.PhotoImage(Image.open("image5.png")) 


place_image=Label(root,image=image1)
...
label = Label(root, text="Assigning Jobs",font=("times",30,"bold"),fg="yellow")
...
label_IT.place(relx=0.01,rely=0.45)
...
label_chemical.place(relx=0.01,rely=0.75)
...
label_selected_doctor.place(relx=0.0000000001, rely=0.3,anchor=W)
